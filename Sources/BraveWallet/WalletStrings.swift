// Copyright 2021 The Kahf Browser Authors. All rights reserved.
...
extension Strings {
  public struct Wallet {
    public static let braveWallet = NSLocalizedString(
      ...
      comment: "The title shown on the wallet settings page, and the value shown when selecting the default wallet as Kahf Browser Wallet in wallet settings."
    )
    public static let wallet = NSLocalizedString(
      ...
      bundle: .module,
      value: "Wallet",
      comment: "The title shown on the menu to access Kahf Browser Wallet"
    )
    ...
    public static let restoreWalletButtonTitle = NSLocalizedString(
      ...
      bundle: .module,
      value: "Restore",
      comment: "The button title for showing the restore wallet screen. As in to use your recovery phrase to bring a wallet into Kahf Browser"
    )
    ...
    public static let setupCryptoTitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Welcome to the new Kahf Browser Wallet",
    ...
    public static let setupCryptoSubtitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Hold crypto assets in your custody and track portfolio performance. All right from the Kahf Browser privacy browser.",
    ...
    public static let restoreWalletSubtitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Enter your recovery phrase to restore your Kahf Browser wallet crypto account.",
    ...
    public static let restoreWalletImportFromLegacyBraveWallet = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Import from legacy Kahf Browser crypto wallets?",
      comment: "A toggle label to ask the user if their 24-word phrase is a legacy Kahf Browser crypto wallet"
    )
    ...
    public static let settingsResetWalletAlertTitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Are you sure you want to reset Kahf Browser Wallet?",
    ...
    public static let biometricsSetupTitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Unlock Kahf Browser Wallet with your Face ID, Touch ID, or password.",
    ...
    public static let autoLockFooter = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "The number of minutes to wait until the Kahf Browser Wallet is automatically locked",
    ...
    public static let swapCryptoUnsupportNetworkDescription = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Kahf Browser doesn't currently support swap on the %@. Please switch to a supported chain.",
    ...
    public static let swapDexAggrigatorNote = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Kahf Browser uses 0x as a DEX aggregator.",
    ...
    public static let swapDexAggrigatorDisclaimer = NSLocalizedString(
      ...
      comment: "A longer disclaimer about the DEX aggrigator used by Kahf Browser for swap transactions. '0x' is a company name. 'DEX aggregator' is a type of blockchain-based service (decentralized exchange). 'ONLY' is emphasized to show importance of 0x's data usage."
    )
    ...
    public static let braveSwapFeeDisclaimer = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Quote includes a %@ Kahf Browser fee.",
      comment: "A disclaimer that appears at the bottom of an swap screen which discloses the fixed Kahf Browser fee included in the swap quotes. '%@' will be replaced by a percentage. For example: 'Quote includes a 0.875% Kahf Browser fee'"
    )
    ...
    public static let recoveryPhraseScreenshotDetectedMessage = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Warning: A screenshot of your recovery phrase may get backed up to a cloud file service, and be readable by any application with photos access. Kahf Browser recommends that you not save this screenshot, and delete it as soon as possible.",
    ...
    public static let privateKeyScreenshotDetectedMessage = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Warning: A screenshot of your private key may get backed up to a cloud file service, and be readable by any application with photos access. Kahf Browser recommends that you not save this screenshot, and delete it as soon as possible.",
    ...
    public static let dappsConnectionNotificationTitle = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "This page wants to interact with Kahf Browser Wallet",
      comment: "The title of the notification which will prompt at the top of the browser when users are visiting web3 site that is not yet connected with Kahf Browser Wallet."
    )
    public static let dappsConnectionNotificationOriginTitle = NSLocalizedString(
      "wallet.dappsConnectionNotificationOriginTitle",
      tableName: "BraveWallet",
      bundle: .module,
      value: "%@ wants to interact with Kahf Browser Wallet",
      comment: "The title of the notification which will prompt at the top of the browser when users are visiting web3 site that is not yet connected with Kahf Browser Wallet. The '%@' will be the site attempting to connect. For example: \"app.uniswap.org wants to interact with Kahf Browser Wallet\""
    )
    ...
    public static let newSiteConnectMessage = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Connect to Kahf Browser Wallet",
    ...
    public static let addNetworkDescription = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "This will allow this network to be used within Kahf Browser Wallet.",
    ...
    public static let editSiteConnectionScreenTitle = NSLocalizedString(
      ...
      bundle: .module,
      value: "Connections",
      comment: "The navigation title of the screen for users to edit dapps site connection with users' Kahf Browser Wallet accounts."
    )
    ...
    public static let decryptMessageScreenshotDetectedMessage = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "Warning: A screenshot of your message may get backed up to a cloud file service, and be readable by any application with photos access. Kahf Browser recommends that you not save this screenshot, and delete it as soon as possible.",
    ...
    public static let networkNotSupportedForBuyToken = NSLocalizedString(
      ...
      comment: "A placeholder in Buy Screen, when user switched to a network that Kahf Browser currently doesn't support token purchasing."
    )
    ...
    public static let dappsSettingsConnectedSitesSectionEmpty = NSLocalizedString(
      ...
      tableName: "BraveWallet",
      bundle: .module,
      value: "DApps you connect to Kahf Browser Wallet will appear here",
