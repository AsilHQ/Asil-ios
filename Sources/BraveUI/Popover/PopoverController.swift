...
public class PopoverController: UIViewController {
  ...
  public var outerMargins: UIEdgeInsets
  ...
  /// Create a popover displaying a content controller
    public init(contentController: UIViewController & PopoverContentComponent, contentSizeBehavior: ContentSizeBehavior = .autoLayout(), contentOutherMargins: UIEdgeInsets = UIEdgeInsets(top: 10.0, left: 10.0, bottom: 10.0, right: 10.0)) {
    self.contentController = contentController
    self.contentSizeBehavior = contentSizeBehavior
    self.outerMargins = contentOutherMargins
